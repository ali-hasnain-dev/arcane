    ...
    return (
        <AuthLayout title="Two-factor authentication">
            <div className="mb-5 flex flex-col items-center gap-2 text-center">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--arcane-primary,#18181b)]/10 dark:bg-[var(--arcane-primary,#18181b)]/20">
                    <ShieldCheck className="h-6 w-6 text-[var(--arcane-primary,#18181b)] dark:text-zinc-300" />
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                ...
                <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
                    <Link
                        ...
                        className="text-[var(--arcane-primary,#18181b)] dark:text-zinc-300 hover:underline"
                    >
                        Back to login
                    </Link>
                </p>
